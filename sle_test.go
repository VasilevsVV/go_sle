...
func TestSle(t *testing.T) {
	...
	results := [][]float64{
		...
		[]float64{-0.0854486486, 1.0893912016, -0.6491091389, -0.2816926027,
			-0.6185427379, -1.2671235885, 0.5395247648, -0.0675559173},
		[]float64{1.2106107148, -0.5511810357, 0.5321367500, -0.2105863700, -0.7306853426,
			-0.7378783187, 1.2849789619, 0.6488343985, 1.1705003456, 0.7786916242},
		// []float64{-0.3115411222, 0.0683765696, -0.3478120152,
